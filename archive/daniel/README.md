...
1. Open `step6_npl_latest_pipeline.ipynb` in Colab and set the runtime to GPU (`Runtime → Change runtime type → T4 GPU`).
...
Daniel Massoud · Shanthosh · Hermes Barreiro Pena
